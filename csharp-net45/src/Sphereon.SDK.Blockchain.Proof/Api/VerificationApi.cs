...
namespace Sphereon.SDK.Blockchain.Proof.Api
{
    ...
    public interface IVerificationApi : IApiAccessor
    {
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>ApiResponse of VerifyContentResponse</returns>
        ApiResponse<VerifyContentResponse> VerifyUsingStreamWithHttpInfo (string configName, System.IO.Stream stream, string fileName = null);
        ...
        System.Threading.Tasks.Task<VerifyContentResponse> VerifyUsingContentAsync (string configName, ContentRequest existence);
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>Task of VerifyContentResponse</returns>
        System.Threading.Tasks.Task<VerifyContentResponse> VerifyUsingStreamAsync (string configName, System.IO.Stream stream, string fileName = null);
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>Task of ApiResponse (VerifyContentResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<VerifyContentResponse>> VerifyUsingStreamAsyncWithHttpInfo (string configName, System.IO.Stream stream, string fileName = null);
    ...
    public partial class VerificationApi : IVerificationApi
    {
        ...
        public ApiResponse< VerifyContentResponse > VerifyUsingContentWithHttpInfo (string configName, ContentRequest existence)
        {
            ...
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingContent");
        ...
        /// <param name="existence">Verify content using the current settings</param>
        /// <returns>Task of VerifyContentResponse</returns>
        public async System.Threading.Tasks.Task<VerifyContentResponse> VerifyUsingContentAsync (string configName, ContentRequest existence)
        {
             ApiResponse<VerifyContentResponse> localVarResponse = await VerifyUsingContentAsyncWithHttpInfo(configName, existence);
             return localVarResponse.Data;
        ...
        /// <param name="existence">Verify content using the current settings</param>
        /// <returns>Task of ApiResponse (VerifyContentResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VerifyContentResponse>> VerifyUsingContentAsyncWithHttpInfo (string configName, ContentRequest existence)
        {
            // verify the required parameter 'configName' is set
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingContent");
        ...
        /// <summary>
        /// Verify hash using the Storage API Verify a convertInputToHashWhenNeeded of file/blob by supplying a Stream location of the Storage API. This Stream Location maps to a location of a file/blob on some remote cloud storage. Hashing will be done on the server side Please note that the binary data itself will not be stored, only the convertInputToHashWhenNeeded. Use the registerUsingContent endpoint if you&#39;d like to store content
        /// </summary>
        /// <exception cref="Sphereon.SDK.Blockchain.Proof.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configName">The context for this operation</param>
        /// <param name="streamLocations">The stream locations on storage</param>
        ...
        public ApiResponse< VerifyContentResponse > VerifyUsingLocationWithHttpInfo (string configName, List<StreamLocation> streamLocations)
        {
            // verify the required parameter 'configName' is set
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingLocation");
        ...
        /// <param name="streamLocations">The stream locations on storage</param>
        /// <returns>Task of VerifyContentResponse</returns>
        public async System.Threading.Tasks.Task<VerifyContentResponse> VerifyUsingLocationAsync (string configName, List<StreamLocation> streamLocations)
        {
             ApiResponse<VerifyContentResponse> localVarResponse = await VerifyUsingLocationAsyncWithHttpInfo(configName, streamLocations);
             return localVarResponse.Data;
        ...
        /// <param name="streamLocations">The stream locations on storage</param>
        /// <returns>Task of ApiResponse (VerifyContentResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VerifyContentResponse>> VerifyUsingLocationAsyncWithHttpInfo (string configName, List<StreamLocation> streamLocations)
        {
            // verify the required parameter 'configName' is set
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingLocation");
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>VerifyContentResponse</returns>
        public VerifyContentResponse VerifyUsingStream (string configName, System.IO.Stream stream, string fileName = null)
        {
             ApiResponse<VerifyContentResponse> localVarResponse = VerifyUsingStreamWithHttpInfo(configName, stream, fileName);
             return localVarResponse.Data;
        }
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>ApiResponse of VerifyContentResponse</returns>
        public ApiResponse< VerifyContentResponse > VerifyUsingStreamWithHttpInfo (string configName, System.IO.Stream stream, string fileName = null)
        {
            // verify the required parameter 'configName' is set
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingStream");
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>Task of VerifyContentResponse</returns>
        public async System.Threading.Tasks.Task<VerifyContentResponse> VerifyUsingStreamAsync (string configName, System.IO.Stream stream, string fileName = null)
        {
             ApiResponse<VerifyContentResponse> localVarResponse = await VerifyUsingStreamAsyncWithHttpInfo(configName, stream, fileName);
             return localVarResponse.Data;
        ...
        /// <param name="fileName">Optional input file name. Needed when using bytestreams instead of filestreams (optional)</param>
        /// <returns>Task of ApiResponse (VerifyContentResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VerifyContentResponse>> VerifyUsingStreamAsyncWithHttpInfo (string configName, System.IO.Stream stream, string fileName = null)
        {
            // verify the required parameter 'configName' is set
            if (configName == null)
                throw new ApiException(400, "Missing required parameter 'configName' when calling VerificationApi->VerifyUsingStream");
