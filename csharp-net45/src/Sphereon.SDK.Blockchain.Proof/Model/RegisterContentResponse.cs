...
namespace Sphereon.SDK.Blockchain.Proof.Model
{
    ...
    public partial class RegisterContentResponse :  IEquatable<RegisterContentResponse>, IValidatableObject
    {
        ...
        public RegisterContentResponse(ContentRequest ContentRequest = default(ContentRequest), CommittedChain ProofChain = default(CommittedChain), RegistrationStateEnum? RegistrationState = default(RegistrationStateEnum?))
        {
            // to ensure "ContentRequest" is required (not null)
            if (ContentRequest == null)
            {
                throw new InvalidDataException("ContentRequest is a required property for RegisterContentResponse and cannot be null");
            }
            else
            {
