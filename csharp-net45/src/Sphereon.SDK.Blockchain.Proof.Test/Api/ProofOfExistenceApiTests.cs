...
{
    /// <summary>
    ///  Class for testing ProofOfExistenceApi
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class ProofOfExistenceApiTests
    {
        private ProofOfExistenceApi instance;
        ...
        public void Init()
        {
            instance = new ProofOfExistenceApi();
        }
        ...
        /// <summary>
        /// Test an instance of ProofOfExistenceApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' ProofOfExistenceApi
            //Assert.IsInstanceOfType(typeof(ProofOfExistenceApi), instance, "instance is a ProofOfExistenceApi");
        }
        ...
        public void RegisterStreamTest()
        {
            ...
            //System.IO.Stream settings = null;
            //var response = instance.RegisterStream(chainId, stream, settings);
            //Assert.IsInstanceOf<RegisterContentResponse> (response, "response is RegisterContentResponse");
        }
        ...
        /// <summary>
        /// Test VerifyContentByHash
        /// </summary>
        [Test]
        public void VerifyContentByHashTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string chainId = null;
            //string hash = null;
            //ContentRequest existence = null;
            //var response = instance.VerifyContentByHash(chainId, hash, existence);
            //Assert.IsInstanceOf<VerifyContentResponse> (response, "response is VerifyContentResponse");
        }
        ...
        public void VerifyStreamTest()
        {
            ...
            //System.IO.Stream stream = null;
            //System.IO.Stream settings = null;
            //var response = instance.VerifyStream(chainId, stream, settings);
            //Assert.IsInstanceOf<VerifyContentResponse> (response, "response is VerifyContentResponse");
        }
