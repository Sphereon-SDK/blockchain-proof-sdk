    ...
    public OffsetDateTime read(JsonReader in) throws IOException {
        switch (in.peek()) {
            ...
            default:
                ...
                int dotZeroPos = date.indexOf(".000000000");
                if (dotZeroPos > -1) {
                    Date fromEpoch = new Date(Long.parseLong(date.substring(0, dotZeroPos)) * 1000);
                    ZonedDateTime temporal = fromEpoch.toInstant().atZone(ZoneId.systemDefault());
                    return OffsetDateTime.of(LocalDateTime.from(temporal), ZoneOffset.from(temporal));
                }
