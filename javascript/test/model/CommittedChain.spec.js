...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.CommittedChain();
  });
  ...
  describe('CommittedChain', function() {
    it('should create an instance of CommittedChain', function() {
      // uncomment below and update the code to test CommittedChain
      //var instane = new SphereonBlockchainProofApi.CommittedChain();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.CommittedChain);
    });
