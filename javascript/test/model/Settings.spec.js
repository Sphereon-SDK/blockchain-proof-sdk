...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.Settings();
  });
  ...
  describe('Settings', function() {
    it('should create an instance of Settings', function() {
      ...
      //var instane = new SphereonBlockchainProofApi.Settings();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.Settings);
    });

    it('should have the property includeContentSize (base name: "includeContentSize")', function() {
      // uncomment below and update the code to test the property includeContentSize
      //var instane = new SphereonBlockchainProofApi.Settings();
