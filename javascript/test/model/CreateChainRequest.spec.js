...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.CreateChainRequest();
  });
  ...
  describe('CreateChainRequest', function() {
    it('should create an instance of CreateChainRequest', function() {
      // uncomment below and update the code to test CreateChainRequest
      //var instane = new SphereonBlockchainProofApi.CreateChainRequest();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.CreateChainRequest);
    });
