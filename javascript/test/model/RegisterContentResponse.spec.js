...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.RegisterContentResponse();
  });
  ...
  describe('RegisterContentResponse', function() {
    it('should create an instance of RegisterContentResponse', function() {
      ...
      //var instane = new SphereonBlockchainProofApi.RegisterContentResponse();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.RegisterContentResponse);
    });

    it('should have the property contentRequest (base name: "contentRequest")', function() {
      // uncomment below and update the code to test the property contentRequest
      //var instane = new SphereonBlockchainProofApi.RegisterContentResponse();
