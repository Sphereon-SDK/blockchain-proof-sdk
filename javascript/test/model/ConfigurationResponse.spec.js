...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainProof.ConfigurationResponse();
  });
  ...
  describe('ConfigurationResponse', function() {
    it('should create an instance of ConfigurationResponse', function() {
      ...
      //var instane = new BlockchainProof.ConfigurationResponse();
      //expect(instance).to.be.a(BlockchainProof.ConfigurationResponse);
    });

    it('should have the property storedSettings (base name: "storedSettings")', function() {
      // uncomment below and update the code to test the property storedSettings
      //var instane = new BlockchainProof.ConfigurationResponse();
