...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.VndErrors();
  });
  ...
  describe('VndErrors', function() {
    it('should create an instance of VndErrors', function() {
      // uncomment below and update the code to test VndErrors
      //var instane = new SphereonBlockchainProofApi.VndErrors();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.VndErrors);
    });
