...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainProof.CommittedEntry();
  });
  ...
  describe('CommittedEntry', function() {
    it('should create an instance of CommittedEntry', function() {
      // uncomment below and update the code to test CommittedEntry
      //var instane = new BlockchainProof.CommittedEntry();
      //expect(instance).to.be.a(BlockchainProof.CommittedEntry);
    });
