...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SphereonBlockchainProofApi.ContentRequest();
  });
  ...
  describe('ContentRequest', function() {
    it('should create an instance of ContentRequest', function() {
      ...
      //var instane = new SphereonBlockchainProofApi.ContentRequest();
      //expect(instance).to.be.a(SphereonBlockchainProofApi.ContentRequest);
    });
    ...
    it('should have the property hashProvider (base name: "hashProvider")', function() {
      // uncomment below and update the code to test the property hashProvider
      //var instane = new SphereonBlockchainProofApi.ContentRequest();
      //expect(instance).to.be();
    });
