...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainProof.CryptoKeysSettings();
  });
  ...
  describe('CryptoKeysSettings', function() {
    it('should create an instance of CryptoKeysSettings', function() {
      // uncomment below and update the code to test CryptoKeysSettings
      //var instane = new BlockchainProof.CryptoKeysSettings();
      //expect(instance).to.be.a(BlockchainProof.CryptoKeysSettings);
    });
