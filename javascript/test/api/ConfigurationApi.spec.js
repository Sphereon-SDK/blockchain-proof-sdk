...
(function(root, factory) {
  ...
  describe('ConfigurationApi', function() {
    ...
    describe('getCurrentConfiguration', function() {
      it('should call getCurrentConfiguration successfully', function(done) {
        //uncomment below and update the code to test getCurrentConfiguration
        //instance.getCurrentConfiguration(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
