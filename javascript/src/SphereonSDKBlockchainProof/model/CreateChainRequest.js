...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('settingsChainId')) {
        obj['settingsChainId'] = ApiClient.convertToType(data['settingsChainId'], 'String');
      }
      if (data.hasOwnProperty('name')) {
        obj['name'] = ApiClient.convertToType(data['name'], 'String');
      }
      if (data.hasOwnProperty('previousChainId')) {
        obj['previousChainId'] = ApiClient.convertToType(data['previousChainId'], 'String');
      }
   ...
   * @member {String} settingsChainId
   */
  exports.prototype['settingsChainId'] = undefined;
  /**
   ...
   * @member {String} previousChainId
   */
  exports.prototype['previousChainId'] = undefined;
  /**
