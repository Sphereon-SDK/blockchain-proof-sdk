...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Sphereon-SDK-Blockchain-Proof/ApiClient', 'Sphereon-SDK-Blockchain-Proof/model/VndError'], factory);
    ...
    root.SphereonBlockchainProofApi.VndErrors = factory(root.SphereonBlockchainProofApi.ApiClient, root.SphereonBlockchainProofApi.VndError);
  }
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/VndErrors
   * @version 0.1.0
   */
   ...
   * The error response
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/VndErrors
   * @class
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/VndErrors} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/VndErrors} The populated <code>VndErrors</code> instance.
   */
  ...
  /**
   * @member {Array.<module:Sphereon-SDK-Blockchain-Proof/model/VndError>} errors
   */
