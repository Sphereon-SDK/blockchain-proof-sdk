...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Sphereon-SDK-Blockchain-Proof/ApiClient'], factory);
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/Settings
   * @version 0.1.0
   */
   ...
   * Existence Settings
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/Settings
   * @class
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/Settings} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/Settings} The populated <code>Settings</code> instance.
   */
   ...
   * @member {module:Sphereon-SDK-Blockchain-Proof/model/Settings.HashAlgorithmEnum} hashAlgorithm
   */
