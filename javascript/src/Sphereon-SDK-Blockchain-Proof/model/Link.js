...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SphereonBlockchainProofApi.Link = factory(root.SphereonBlockchainProofApi.ApiClient);
  }
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/Link
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>Link</code>.
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/Link
   * @class
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/Link} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/Link} The populated <code>Link</code> instance.
   */
