...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SphereonBlockchainProofApi.CommittedChain = factory(root.SphereonBlockchainProofApi.ApiClient);
  }
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/CommittedChain
   * @version 0.1.0
   */
   ...
   * Commited Chain
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/CommittedChain
   * @class
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/CommittedChain} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/CommittedChain} The populated <code>CommittedChain</code> instance.
   */
