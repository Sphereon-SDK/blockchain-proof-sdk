...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Sphereon-SDK-Blockchain-Proof/ApiClient', 'Sphereon-SDK-Blockchain-Proof/model/Link'], factory);
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/VndError
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>VndError</code>.
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/VndError
   * @class
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/VndError} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/VndError} The populated <code>VndError</code> instance.
   */
  ...
  /**
   * @member {Object.<String, module:Sphereon-SDK-Blockchain-Proof/model/Link>} _links
   */
