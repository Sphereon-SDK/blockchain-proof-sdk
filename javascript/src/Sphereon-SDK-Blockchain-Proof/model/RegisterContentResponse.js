...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SphereonBlockchainProofApi.RegisterContentResponse = factory(root.SphereonBlockchainProofApi.ApiClient, root.SphereonBlockchainProofApi.CommittedChain, root.SphereonBlockchainProofApi.ContentRequest);
  }
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse
   * @version 0.1.0
   */
   ...
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse
   * @class
   ...
   * @param registrationState {module:Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse.RegistrationStateEnum} 
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse} The populated <code>RegisterContentResponse</code> instance.
   */
  ...
  /**
   * @member {module:Sphereon-SDK-Blockchain-Proof/model/RegisterContentResponse.RegistrationStateEnum} registrationState
   */
