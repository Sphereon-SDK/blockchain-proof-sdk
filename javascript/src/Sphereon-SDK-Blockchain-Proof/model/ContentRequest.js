...
(function(root, factory) {
   ...
   * @module Sphereon-SDK-Blockchain-Proof/model/ContentRequest
   * @version 0.1.0
   */
   ...
   * @alias module:Sphereon-SDK-Blockchain-Proof/model/ContentRequest
   * @class
   * @param hashProvider {module:Sphereon-SDK-Blockchain-Proof/model/ContentRequest.HashProviderEnum} When CLIENT is supplied the content should already have been hashed by you. When SERVER is supplied we will hash the content according to the supplied settings
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/model/ContentRequest} obj Optional instance to populate.
   * @return {module:Sphereon-SDK-Blockchain-Proof/model/ContentRequest} The populated <code>ContentRequest</code> instance.
   */
  ...
  /**
   * @member {module:Sphereon-SDK-Blockchain-Proof/model/Settings} settings
   */
   ...
   * @member {module:Sphereon-SDK-Blockchain-Proof/model/ContentRequest.HashProviderEnum} hashProvider
   */
