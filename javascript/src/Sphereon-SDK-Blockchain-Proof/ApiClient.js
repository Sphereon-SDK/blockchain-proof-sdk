...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SphereonBlockchainProofApi.ApiClient = factory(root.superagent);
  }
}(this, function(superagent) {
  'use strict';

  /**
   * @module Sphereon-SDK-Blockchain-Proof/ApiClient
   * @version 0.1.0
   */
   ...
   * @alias module:Sphereon-SDK-Blockchain-Proof/ApiClient
   * @class
   */
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
   ...
   * @callback module:Sphereon-SDK-Blockchain-Proof/ApiClient~callApiCallback
   ...
   * @param {module:Sphereon-SDK-Blockchain-Proof/ApiClient~callApiCallback} callback The callback function.
   ...
   * @type {module:Sphereon-SDK-Blockchain-Proof/ApiClient}
   */
