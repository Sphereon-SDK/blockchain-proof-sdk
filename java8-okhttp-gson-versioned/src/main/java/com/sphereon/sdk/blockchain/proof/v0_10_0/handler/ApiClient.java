...
import com.sphereon.sdk.blockchain.proof.v0_10_0.handler.auth.Authentication;
import com.sphereon.sdk.blockchain.proof.v0_10_0.handler.auth.HttpBasicAuth;
import com.sphereon.sdk.blockchain.proof.v0_10_0.handler.auth.ApiKeyAuth;
import com.sphereon.sdk.blockchain.proof.v0_10_0.handler.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://gw.api.cloud.sphereon.com/blockchain/proof/0.10";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gw.api.cloud.sphereon.com/blockchain/proof/0.10
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    ...
                    callback.onFailure(new ApiException("An error occurred whilst reading the API response: " + t.getMessage(),
                        t, response.code(), response.headers().toMultimap(), response.body().string()), response.code(), response.headers().toMultimap());
                    return;
                }
                try {
                    callback.onSuccess(result, response.code(), response.headers().toMultimap());
                } catch (Throwable t) {
                    callback.onFailure(new ApiException("An error occurred in the onSuccess callback: " + t.getMessage(),
                        t, response.code(), response.headers().toMultimap(), response.body().string()), response.code(), response.headers().toMultimap());
                    return;
                }
            }
