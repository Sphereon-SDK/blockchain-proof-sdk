...
package com.sphereon.blockchain.proof.model;

import java.util.Objects;
import com.google.gson.annotations.SerializedName;
import com.sphereon.blockchain.proof.model.Settings;
...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-11-09T03:23:09.341+01:00")
public class ContentRequest   {
  ...
  public ContentRequest settings(Settings settings) {
  ...
  **/
   ...
   * @return hashProvider
  **/
  @ApiModelProperty(example = "null", required = true, value = "When CLIENT is supplied the content should already have been hashed by you. When SERVER is supplied we will hash the content according to the supplied settings")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.settings, contentRequest.settings) &&
        Objects.equals(this.hashProvider, contentRequest.hashProvider) &&
        Objects.equals(this.content, contentRequest.content);
  }

  @Override
  public int hashCode() {
    return Objects.hash(settings, hashProvider, content);
  }
