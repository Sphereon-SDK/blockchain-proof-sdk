...
export class RegistrationApi {
     ...
     */
    public registerUsingContent(configName: string, existence: models.ContentRequest, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<models.RegisterContentResponse> {
        return this.registerUsingContentWithHttpInfo(configName, existence, requestId, base64Secret, suppliedSignature, keyId, extraHttpRequestParams)
     ...
     * @param keyId An alternate crypto keys API id that will be used for signature generation.
     */
    public registerUsingLocation(configName: string, streamLocation: models.StreamLocation, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<models.RegisterContentResponse> {
        return this.registerUsingLocationWithHttpInfo(configName, streamLocation, requestId, base64Secret, suppliedSignature, keyId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param keyId An alternate crypto keys API id that will be used for signature generation.
     */
    public registerUsingStream(configName: string, stream: any, fileName?: string, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<models.RegisterContentResponse> {
        return this.registerUsingStreamWithHttpInfo(configName, stream, fileName, requestId, base64Secret, suppliedSignature, keyId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param keyId An alternate crypto keys API id that will be used for signature generation.
     */
    public registerUsingContentWithHttpInfo(configName: string, existence: models.ContentRequest, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param keyId An alternate crypto keys API id that will be used for signature generation.
     */
    public registerUsingLocationWithHttpInfo(configName: string, streamLocation: models.StreamLocation, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param keyId An alternate crypto keys API id that will be used for signature generation.
     */
    public registerUsingStreamWithHttpInfo(configName: string, stream: any, fileName?: string, requestId?: string, base64Secret?: string, suppliedSignature?: string, keyId?: string, extraHttpRequestParams?: any): Observable<Response> {
