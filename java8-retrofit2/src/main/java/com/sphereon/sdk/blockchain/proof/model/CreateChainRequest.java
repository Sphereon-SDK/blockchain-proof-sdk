...
public class CreateChainRequest {
   ...
   * @return metadata
  **/
  @ApiModelProperty(value = "Metadata for this chain.")
  ...
  **/
  @ApiModelProperty(value = "Supply an existing settings chain. When not supplied a new settings chain will be created automatically.")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Unique name for this chain.")
  ...
  **/
  @ApiModelProperty(value = "When this chain is a continuation of another chain you need to supply the previous chainId here.")
